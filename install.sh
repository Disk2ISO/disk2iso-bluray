#!/bin/bash
# ===========================================================================
# disk2iso-bluray Module Installation Script
# ===========================================================================
# Installation script for Blu-ray Ripping Module
# ===========================================================================
...
# Copy library
cp -v lib/libbluray.sh "$INSTALL_DIR/lib/"
chmod 755 "$INSTALL_DIR/lib/libbluray.sh"

# Copy configuration
cp -v conf/libbluray.ini "$INSTALL_DIR/conf/"
chmod 644 "$INSTALL_DIR/conf/libbluray.ini"

# Copy language files
cp -v lang/libbluray.* "$INSTALL_DIR/lang/"
chmod 644 "$INSTALL_DIR/lang/libbluray".*

# Copy documentation
echo -e "${YELLOW}Installing documentation...${NC}"
cp -rv doc/04_Module "$INSTALL_DIR/doc/"
chmod 644 "$INSTALL_DIR/doc/04_Module/04-3_BD-Video.md"
...
echo "3. View documentation: cat $INSTALL_DIR/doc/04_Module/04-3_BD-Video.md"
echo ""
